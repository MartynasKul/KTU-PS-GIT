...
project -result_file {E:/KTU PIRMI METAI/Pavasario semestras/Skaitmenine Logika/Ketvirtas laboras/impl1/ketvlab_impl1.edi}

#-- error message log file
project -log_file {ketvlab_impl1.srf}
