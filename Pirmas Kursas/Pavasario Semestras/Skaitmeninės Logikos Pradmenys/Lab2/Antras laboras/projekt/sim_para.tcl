...
set ::bali::simulation::Para(PROJECT) {projekt}
set ::bali::simulation::Para(PROJECTPATH) {E:/KTU PIRMI METAI/Pavasario semestras/Skaitmenine Logika/Antras laboras}
set ::bali::simulation::Para(FILELIST) {"E:/KTU PIRMI METAI/Pavasario semestras/Skaitmenine Logika/Antras laboras/impl1/Schema.vhd" }
