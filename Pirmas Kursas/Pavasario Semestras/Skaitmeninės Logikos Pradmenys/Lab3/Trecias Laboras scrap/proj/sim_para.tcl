...
set ::bali::simulation::Para(PROJECT) {proj}
set ::bali::simulation::Para(PROJECTPATH) {E:/KTU PIRMI METAI/Pavasario semestras/Skaitmenine Logika/Trecias Laboras}
set ::bali::simulation::Para(FILELIST) {"E:/KTU PIRMI METAI/Pavasario semestras/Skaitmenine Logika/Trecias Laboras/impl1/sch.vhd" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {SCH}
