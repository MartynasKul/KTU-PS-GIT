...
-- ldbanno -n VHDL -o KetvirtasLaboras_impl1_mapvho.vho -w -neg -gui -msgset E:/KTU PIRMI METAI/Pavasario semestras/Skaitmenine Logika/Trecias laboras/promote.xml KetvirtasLaboras_impl1_map.ncd 
-- Netlist created on Thu May 05 09:39:37 2022
-- Netlist written on Thu May 05 09:49:17 2022
...
-- entity TOP_CNT
  ...
  begin
    ...
    CNT_2_SLICE_1I: SCCU2B
      ...
      port map (M1=>'X', A1=>CNT_2_CNT_A_6, B1=>'X', C1=>'X', D1=>CNT_2_VCC, 
    ...
    CNT_2_SLICE_2I: SCCU2B
      ...
      port map (M1=>'X', A1=>CNT_2_O_4, B1=>'X', C1=>'X', D1=>CNT_2_VCC, 
    ...
    CNT_2_SLICE_3I: SCCU2B
      generic map (CCU2_INJECT1_0=>"NO", CCU2_INJECT1_1=>"NO", 
                   INIT0_INITVAL=>"0xAA00", INIT1_INITVAL=>"0xAA00")
      port map (M1=>'X', A1=>CNT_2_CNT_A_2, B1=>'X', C1=>'X', D1=>CNT_2_VCC, 
                DI1=>'X', DI0=>'X', A0=>CNT_2_CNT_A_1, B0=>'X', C0=>'X', 
    ...
    CNT_2_SLICE_4I: SCCU2B
      generic map (CCU2_INJECT1_0=>"NO", INIT0_INITVAL=>"0x00FF", 
                   INIT1_INITVAL=>"0xAAAA")
      port map (M1=>'X', A1=>CNT_2_CNT_A_0, B1=>'X', C1=>'X', D1=>'X', 
    ...
    CNT_1_SLICE_5I: SCCU2B
      ...
      port map (M1=>'X', A1=>CNT_1_CNT_A_0, B1=>'X', C1=>'X', D1=>CNT_1_VCC, 
    ...
    CNT_1_SLICE_6I: SCCU2B
      ...
      port map (M1=>'X', A1=>CNT_1_CNT_A_4, B1=>'X', C1=>'X', D1=>'X', 
                DI1=>'X', DI0=>'X', A0=>CNT_1_O_3, B0=>'X', C0=>'X', 
    ...
    CNT_1_SLICE_8I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", REG0_REGSET=>"SET", 
                   ...
                   CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>CNT_1_CNT_A_4, B1=>CNT_1_O_1, 
                C1=>'X', D1=>'X', DI1=>'X', DI0=>CNT_1_cnt_c2_0_0_i, 
                A0=>CNT_1_CNT_A_0, B0=>CNT_1_CNT_A_2, C0=>CNT_1_cnt_c2_1, 
                D0=>CNT_1_O_3, M0=>'X', CE=>ENBL_I_c, CLK=>CLK_I_c, LSR=>'X', 
                OFX1=>open, F1=>CNT_1_cnt_c2_1, Q1=>open, OFX0=>open, 
                F0=>CNT_1_cnt_c2_0_0_i, Q0=>C1);
    CNT_1_SLICE_9I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", LUT0_INITVAL=>X"44C4", 
                   LUT1_INITVAL=>X"44C4", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>CNT_1_CNT_A_4, 
                B1=>CNT_1_CNT_A_s_2, C1=>CNT_1_cnt_a9lt3, D1=>CNT_1_O_3, 
                DI1=>CNT_1_CNT_A_lm_2, DI0=>CNT_1_CNT_A_lm_0, 
                A0=>CNT_1_CNT_A_4, B0=>CNT_1_CNT_A_s_0, C0=>CNT_1_cnt_a9lt3, 
                D0=>CNT_1_O_3, M0=>'X', CE=>ENBL_I_c, CLK=>CLK_I_c, LSR=>'X', 
                OFX1=>open, F1=>CNT_1_CNT_A_lm_2, Q1=>CNT_1_CNT_A_2, 
                OFX0=>open, F0=>CNT_1_CNT_A_lm_0, Q0=>CNT_1_CNT_A_0);
    CNT_1_SLICE_10I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", LUT0_INITVAL=>X"444C", 
                   LUT1_INITVAL=>X"8888", REG0_SD=>"VHI", CHECK_DI0=>TRUE, 
                   CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>CNT_1_CNT_A_2, B1=>CNT_1_O_1, 
                C1=>'X', D1=>'X', DI1=>'X', DI0=>CNT_1_CNT_A_lm_4, 
                A0=>CNT_1_CNT_A_4, B0=>CNT_1_CNT_A_s_4, C0=>CNT_1_O_3, 
                D0=>CNT_1_CNT_A_RNO_0_4, M0=>'X', CE=>ENBL_I_c, CLK=>CLK_I_c, 
                LSR=>'X', OFX1=>open, F1=>CNT_1_CNT_A_RNO_0_4, Q1=>open, 
                OFX0=>open, F0=>CNT_1_CNT_A_lm_4, Q0=>CNT_1_CNT_A_4);
    CNT_1_SLICE_11I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", SRMODE=>"ASYNC", 
                   ...
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>CNT_1_CNT_A_4, 
                B1=>CNT_1_CNT_A_s_3, C1=>CNT_1_cnt_a9lt3, D1=>CNT_1_O_3, 
                DI1=>CNT_1_CNT_A_lm_3, DI0=>CNT_1_CNT_A_lm_1, 
                A0=>CNT_1_CNT_A_4, B0=>CNT_1_CNT_A_s_1, C0=>CNT_1_cnt_a9lt3, 
                D0=>CNT_1_O_3, M0=>'X', CE=>ENBL_I_c, CLK=>CLK_I_c, LSR=>'X', 
                OFX1=>open, F1=>CNT_1_CNT_A_lm_3, Q1=>CNT_1_O_3, OFX0=>open, 
                F0=>CNT_1_CNT_A_lm_1, Q0=>CNT_1_O_1);
    CNT_2_SLICE_12I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", SRMODE=>"ASYNC", 
                   LSRONMUX=>"OFF", LUT0_INITVAL=>X"1515", 
                   LUT1_INITVAL=>X"7070", REG1_SD=>"VHI", REG0_SD=>"VHI", 
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>CNT_2_cnt_c3_4, 
                B1=>CNT_2_cnt_c3_5, C1=>CNT_2_un4_cnt_a_1_cry_1_0_S0, D1=>'X', 
                DI1=>CNT_2_CNT_A_3_1, DI0=>CNT_2_CNT_A_3_0, A0=>CNT_2_CNT_A_0, 
                B0=>CNT_2_cnt_c3_4, C0=>CNT_2_cnt_c3_5, D0=>'X', M0=>'X', 
    ...
    CNT_2_SLICE_13I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"SIG", SRMODE=>"ASYNC", 
                   ...
                   CHECK_DI1=>TRUE, CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>CNT_2_cnt_c3_4, 
                B1=>CNT_2_cnt_c3_5, C1=>CNT_2_un4_cnt_a_1_cry_5_0_S0, D1=>'X', 
                DI1=>CNT_2_CNT_A_3_5, DI0=>CNT_2_CNT_A_3_2, A0=>CNT_2_cnt_c3_4, 
                B0=>CNT_2_cnt_c3_5, C0=>CNT_2_un4_cnt_a_1_cry_1_0_S1, D0=>'X', 
                M0=>'X', CE=>ENBL_I_c, CLK=>C1, LSR=>'X', OFX1=>open, 
                F1=>CNT_2_CNT_A_3_5, Q1=>CNT_2_CNT_A_5, OFX0=>open, 
    ...
    CNT_2_SLICE_14I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>CNT_2_CNT_A_1, 
                B1=>CNT_2_CNT_A_2, C1=>CNT_2_CNT_A_5, D1=>CNT_2_CNT_A_7, 
                DI1=>'X', DI0=>CNT_2_CNT_A_3_7, A0=>CNT_2_cnt_c3_4, 
                B0=>CNT_2_cnt_c3_5, C0=>CNT_2_un4_cnt_a_1_s_7_0_S0, D0=>'X', 
                M0=>'X', CE=>ENBL_I_c, CLK=>C1, LSR=>'X', OFX1=>open, 
    ...
    SLICE_15I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                ...
                B0=>CNT_1_O_3, C0=>CNT_2_O_4, D0=>'X', M0=>'X', CE=>'X', 
                CLK=>CLK_I_c, LSR=>RST_I_c, OFX1=>open, F1=>open, Q1=>open, 
                OFX0=>open, F0=>un7_cnt_2_o, Q0=>RST_internal);
    SLICE_16I: SLOGICB
      generic map (LUT0_INITVAL=>X"0001", LUT1_INITVAL=>X"7777")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>CNT_1_CNT_A_2, B1=>CNT_1_O_1, 
                C1=>'X', D1=>'X', DI1=>'X', DI0=>'X', A0=>CNT_2_CNT_A_0, 
                B0=>CNT_2_CNT_A_3, C0=>CNT_2_CNT_A_6, D0=>CNT_2_O_4, M0=>'X', 
                CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, F1=>CNT_1_cnt_a9lt3, 
                Q1=>open, OFX0=>open, F0=>CNT_2_cnt_c3_5, Q0=>open);
