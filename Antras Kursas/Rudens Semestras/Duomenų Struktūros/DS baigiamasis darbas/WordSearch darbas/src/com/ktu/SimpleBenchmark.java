...
// Paruošiamoji tyrimo dalis
       ...
       // System.gc();
        ...
        util.WordSearch.createScanner();
        util.WordSearch.readBoard();
        util.WordSearch.printBoard();
        util.WordSearch.processWords();
        long t8 = System.nanoTime();

        long durationInMs = TimeUnit.NANOSECONDS.toMillis(t8-t7);
        Ks.ouf("%7d ms\n", durationInMs);
